...
ax.plot( v_plot_mean, t, label = "High Fairness (Acc:{:.2f}, EO violation:{:.2f})".format(Acc_level,EO_level))
...
EO_level = (x_bin_start+x_bin_end)/2
Acc_level = (y_bin_start+y_bin_end)/2
ax.plot( v_plot_mean, t, label = "Low Fairness (Acc:{:.2f}, EO violation:{:.2f})".format(Acc_level,EO_level))
ax.fill_betweenx(t, v_plot_mean+ v_plot_std, v_plot_mean - v_plot_std,  alpha=0.2)
...
EO_level = (x_bin_start+x_bin_end)/2
Acc_level = (y_bin_start+y_bin_end)/2
ax.plot( v_plot_mean, t, label = "Baseline (Acc:{:.2f}, EO violation:{:.2f})".format(Acc_level,EO_level))
ax.fill_betweenx(t, v_plot_mean+ v_plot_std, v_plot_mean - v_plot_std,  alpha=0.2)
